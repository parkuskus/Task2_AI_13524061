...
def check_constraints(s, trajectory, params=None):
    ...
    # C1: batas dan diskritisasi suku bunga (hard)
    ...
    violations = {"C2": violation_2, "C3": violation_3, "C4": violation_4, "C5": violation_5}

    return {
        "feasible": feasible,
        "C1": c1_ok, "C2": c2_ok, "C3": c3_ok, "C4": c4_ok, "C5": c5_ok,
