...
Bank sentral secara empiris menghindari perubahan suku bunga yang terlalu agresif karena dapat mengguncang ekspektasi pasar dan merusak kredibilitas \textit{forward guidance} (Woodford, 2003). \textit{Constraint} ini membatasi perubahan antar kuartal maksimum sebesar 50 basis poin atau 0,50\%.
...
\begin{lstlisting}[language=Python]
============================================================
           J(s)       #Eval   Waktu(s)   Feasible   pi_T
------------------------------------------------------------
Hill-Climbing   -8.9352      523      2.14       YES   2.55%
Sim. Annealing  -5.1823     1000      4.08       YES   2.48%
Genetic Algo.   -4.9571     10000*    5.73       YES   2.47%
------------------------------------------------------------
*GA: 50 individu x 200 generasi

Best overall: Genetic Algorithm (J = -4.9571)
pi_T terbaik: Genetic Algorithm (2.47%, paling dekat 2.50%)
\end{lstlisting}
\end{tcolorbox}
