...
\begin{enumerate}
    ...
    \item Ketiga, panel status \textit{constraint} yang menampilkan indikator visual (hijau untuk terpenuhi, merah untuk dilanggar) untuk C1 sampai C5 pada kandidat solusi saat ini.
